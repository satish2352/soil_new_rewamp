...
const STRINGS = {
  en: {
    ...
    'vm.title': 'Where we are going, and how we get there',
    'vm.lead': 'A farming future built on living soil — and the work we do every day to reach it.',
    'vm.visionTag': 'The future we see',
    'vm.missionTag': 'What drives us',
    'vm.cta': 'Grow with us',
    ...
    'blog.homeTitle': 'Notes from the field',
  ...
  mr: {
    ...
    'vm.title': 'आम्ही कुठे जात आहोत, आणि तिथे कसे पोहोचणार',
    'vm.lead': 'जिवंत मातीवर उभे असलेले शेतीचे भविष्य — आणि ते गाठण्यासाठी आम्ही दररोज करत असलेले काम.',
    'vm.visionTag': 'आम्हाला दिसणारे भविष्य',
    'vm.missionTag': 'आमची प्रेरणा',
    'vm.cta': 'आमच्यासोबत वाढा',
    ...
    'blog.featured': 'निवडक',
    'blog.homeTitle': 'शेतातून आलेल्या नोंदी',
  ...
  hi: {
    ...
    'vm.title': 'हम कहाँ जा रहे हैं, और वहाँ कैसे पहुँचेंगे',
    'vm.lead': 'जीवित मिट्टी पर टिका खेती का भविष्य — और उस तक पहुँचने के लिए हम हर दिन जो काम करते हैं।',
    'vm.visionTag': 'हमें दिखने वाला भविष्य',
    'vm.missionTag': 'हमारी प्रेरणा',
    'vm.cta': 'हमारे साथ बढ़ें',
    ...
    'blog.featured': 'विशेष',
    'blog.homeTitle': 'खेतों से आई बातें',
